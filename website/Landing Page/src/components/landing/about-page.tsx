    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="relative overflow-hidden pt-32 pb-16 px-4 sm:px-6">
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
          <div className="animate-aurora absolute top-[-120px] left-1/2 h-[500px] w-[850px] -translate-x-1/2 rounded-full bg-gradient-to-r from-violet-600/20 via-pink-500/15 to-rose-500/20 blur-[130px]" />
          <div
            className="animate-aurora absolute right-[-140px] top-[30%] h-[380px] w-[380px] rounded-full bg-gradient-to-br from-pink-500/15 to-violet-600/15 blur-[110px]"
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <Reveal>
            <div className="glass-card mx-auto inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold text-violet-700 dark:text-violet-300 border border-violet-500/30 bg-violet-500/10 shadow-lg">
          ...
          <Reveal delay={100}>
            <h1 className="font-display mt-6 text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl">
...
const [hudState, setHudState] = useState<HudConfig>({
  ...
  vadTrigger: true
      ...
      <Reveal>
        <div className="mx-auto max-w-5xl px-4 pb-24 sm:px-6">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-8 sm:p-12 text-center backdrop-blur-xl shadow-2xl">
            <div
              className="pointer-events-none absolute -inset-8 opacity-15 blur-3xl"
              style={{
            ...
            <Code2 className="mx-auto h-12 w-12 text-violet-500" />
            <h3 className="font-display text-3xl font-extrabold text-foreground mt-4">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a
                ...
                className="btn-shine inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-pink-600 px-8 py-3.5 text-sm font-bold text-white shadow-xl shadow-violet-500/25 transition-all duration-200 hover:scale-105"
              >
      ...
      <div className="pb-16 text-center">
        <button
          onClick={() => navigate({ to: "/" })}
          className="text-sm font-mono text-muted-foreground transition-colors hover:text-violet-500 cursor-pointer"
        >
          ← Back to home
        </button>
      </div>
