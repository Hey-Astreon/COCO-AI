...
export function Hero({ onDownloadClick }: HeroProps) {
  return (
    <div className="relative overflow-hidden bg-[#07070c] text-foreground">
      {/* ─── Ambient Mesh Lighting ─── */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="animate-aurora absolute -top-40 left-1/2 h-[600px] w-[900px] -translate-x-1/2 rounded-full bg-gradient-to-r from-violet-600/25 via-pink-500/20 to-rose-500/15 blur-[140px]" />
        <div
          className="animate-aurora absolute top-20 right-0 h-[450px] w-[450px] rounded-full bg-gradient-to-br from-pink-500/15 to-violet-600/20 blur-[120px]"
          style={{ animationDelay: "-6s" }}
        />
        <div
          className="animate-aurora absolute bottom-0 left-0 h-[500px] w-[500px] rounded-full bg-gradient-to-tr from-violet-600/20 to-pink-500/10 blur-[130px]"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="flex flex-col items-center text-center lg:col-span-6 lg:items-start lg:text-left">
              {/* Badge */}
              <Reveal>
                <div className="glass-card inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold text-violet-300 border border-violet-500/30 shadow-lg shadow-violet-500/10">
              ...
              <Reveal delay={100}>
                <h1 className="font-display mt-6 text-4xl leading-[1.08] font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
                ...
                <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:flex-wrap lg:justify-start">
                  ...
                  <div className="btn-border-wrap">
                    <button
                      ...
                      className="group relative inline-flex cursor-pointer items-center justify-center gap-2 rounded-full bg-zinc-950 px-8 py-4 text-sm font-bold text-white transition-all duration-300 hover:bg-gradient-to-r hover:from-violet-600 hover:to-pink-600 hover:shadow-lg hover:shadow-violet-500/30"
                  ...
                  <a
                    ...
                    className="btn-secondary-lift inline-flex items-center justify-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/90 px-6 py-4 text-sm font-semibold text-zinc-200 transition-all duration-200 hover:bg-zinc-800 hover:text-white"
                  >
              ...
              <Reveal delay={450}>
                <div className="mt-8 flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-2 text-xs font-mono text-violet-300 shadow-md">
